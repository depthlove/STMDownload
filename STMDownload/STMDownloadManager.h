//
//  STMDownloadManager.h
//

#import <Foundation/Foundation.h>
#import "STMCommonHelper.h"
#import "STMDownloadDelegate.h"
#import "STMFileModel.h"
#import "STMHttpRequest.h"

#define kMaxRequestCount  @"kMaxRequestCount"

@interface STMDownloadManager : NSObject<STMHttpRequestDelegate>

/** 获得下载事件的vc，用在比如多选图片后批量下载的情况，这时需配合 allowNextRequest 协议方法使用 */
@property (nonatomic, weak  ) id<STMDownloadDelegate> VCdelegate;
/** 下载列表delegate */
@property (nonatomic, weak  ) id<STMDownloadDelegate> downloadDelegate;
/** 设置最大的并发下载个数 */
...
/** 下载文件的模型 */
@property (nonatomic, strong, readonly) STMFileModel  *fileInfo;
