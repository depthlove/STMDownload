...
typedef NS_ENUM(NSInteger,STMDownLoadState) {
    STMDownloading,      //下载中
    STMWillDownload,     //等待下载
    STMStopDownload      //停止下载
};

@interface STMFileModel : NSObject
 ...
 *所有任务以添加时间排序。
*/
@property (nonatomic, assign) STMDownLoadState downloadState;
/** 是否下载出错 */
